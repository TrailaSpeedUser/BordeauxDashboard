...
function colormapJet(t: number): string {
  // Re-export from shared helpers for backward compatibility within
  // this file. Kept as a function alias so all the existing call sites
  // don't need to change.
  return _colormapJet(t);
}
